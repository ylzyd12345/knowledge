...
source: "https://javaguide.cn/ai-coding/cases/deepseek-v4-claude-code.html"
author:
  - "[[Guide]]"
published: 2026-06-16
created: 2026-07-02
description: "深入体验 DeepSeek V4 与 Claude Code 的集成，实测代码审计、数据库迁移、模型升级等多个场景，评估 V4-Pro 和 V4-Flash 的真实代码能力。重点围绕 Claude Code 接入 DeepSeek V4、实战一：升级 LLM 多 Provider 预设模型列表等核心内容。"
tags:
  - "clippings"
---
...
API Key 创建地址： [https://platform.deepseek.com/](https://platform.deepseek.com/) 。
