...
source: "https://javaguide.cn/ai-coding/practices/claudecode-agentview.html"
author:
  - "[[Guide]]"
published: 2026-06-16
created: 2026-07-02
description: "Anthropic 发布的 Agent View 为 Claude Code 提供了可视化的多会话管理能力，让多个 Agent 会话的状态追踪、权限确认和任务编排变得直观高效，彻底告别终端窗口切换的混乱。重点围绕 怎么打开 Agent View、状态图标、不用切换，也能回复、把任务甩到后台跑 等内容展开。"
tags:
  - "clippings"
---
大家好，我是小 G。
...
- [《Claude Code 使用指南》](https://javaguide.cn/ai-coding/claudecode-tips.html) ：Sub-Agent 子代理、多实例协作（Multi-Claude）、 [CLAUDE.md](http://claude.md/) 配置等
