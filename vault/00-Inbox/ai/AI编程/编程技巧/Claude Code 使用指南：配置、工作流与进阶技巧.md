...
source: "https://javaguide.cn/ai-coding/practices/claudecode-tips.html"
author:
  - "[[Guide]]"
published: 2026-06-16
created: 2026-06-29
description: "结合 Anthropic 官方文档和真实项目用法，讲清 Claude Code 的配置、权限、MCP、Skills、Sub-Agent、上下文管理和常见工作流。重点围绕 CLAUDE.md 非常重要、权限管理要重视、安全边界、MCP、Skills、Sub-Agent 和插件怎么分 等内容展开。"
tags:
  - "clippings"
---
你好，我是小 G。前几天那篇 [Vibe Coding 实用技巧总结](https://javaguide.cn/ai-coding/practices/the-cool-tricks-for-vibe-coding.html) ，公众号阅读两天时间到了 6w+，评论区里问 Claude Code 的朋友不少。
